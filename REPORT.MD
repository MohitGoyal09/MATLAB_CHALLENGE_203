...
2. In the Video Labeler, load a video and create `PixelLabel` definitions for the target classes (e.g., "car", "person").
3. Navigate to the **Automate** tab, **Refresh list**, and select the desired algorithm.
